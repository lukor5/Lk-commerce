  ...
  <div class="popup-wrapper">
    <div class="popup">
      ...
      <div class="product-row">
        <div class="product-wrapper" v-if="primaryProduct">
          ...
          <button
            class="icon-button"
            @click="
              (this.primaryProduct = null), (this.productCount = 'primary')
            "
          >
      ...
      <div class="button-row">
        ...
        <button
          @click="createBundle"
          v-if="primaryProduct && discountedProduct && discount"
...
export default {
  ...
  computed: {
    maxDiscount() {
      if (this.discountedProduct) {
        return (
          Math.round(
            this.discountedProduct.price * this.discountedProduct.discount * 100
          ) / 100
        );
      }
      return null;
  ...
  methods: {
    ...
    createBundle() {
      ...
      axios
        .post(`${this.baseUrl}/create-bundle`, data)
        .then((response) => {
